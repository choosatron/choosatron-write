...
.config(['$routeProvider', function($routeProvider) {
	...
	$routeProvider.when('/choosatron', {templateUrl: 'templates/choosatron.view.html', controller: 'ChoosatronsCtrl', controllerAs: 'vm'});
	$routeProvider.when('/choosatrons', {templateUrl: 'templates/choosatrons.view.html', controller: 'ChoosatronsCtrl', controllerAs: 'vm'});
